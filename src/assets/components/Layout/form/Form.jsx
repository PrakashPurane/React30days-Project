...
<div className="container my-3 px-4 lg:px-20 ">
  ...
  <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
        ...
        type="number" placeholder="Category*" name='category' onChange={handleChange} required />
            ...
            <div className="my-4">
                <textarea  required placeholder="Description*"  onChange={handleChange} name='description' className="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
            </div>
